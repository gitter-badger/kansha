...
class UserProfile(object):
    def __init__(self, app_title, app_banner, theme, user, search_engine, templates_config, services_service):
        """
        In:
...
class UserBoards(object):
    def __init__(self, app_title, app_banner, theme, user, templates_config, mail_sender_service, assets_manager_service, services_service):
        """ UserBoards
